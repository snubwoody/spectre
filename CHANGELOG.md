...
- Add `spectre` binary to Cargo.toml
...
- Update test step to use a matrix runner
- Remove `--no-fail-fast` argument when testing
- Run build on matrix runner
- Try cargo nextest
- Formatting
- Clippy
- Disable macos in test job
- Disable fail fast on matrix runners
- Formatting
- Re-enable macos runner
- Fixed wrong cargo command
- Set `SPECTRE_TEST_PORT`
- Formatting
- Clippy
- Formatting
...
- Update ci to use rust
- Added step for downloading chrome
- Run `cargo test` in testing workflow
- Cache cargo in windows workflow
- Add `SPECTRE_PORT` env variable
- Cache cargo in windows build job
- Formatting
- Clippy fix
- All tests passing
- Formatting
- Added linting to github workflows
- Formatting
- Clippy
- Clippy
- Formatting
...
- Formatting
- Clippy
- Delete linux workflow
- Rename windows ci to ci
- Formatting
- Formatting
- Fix clippy warnings
